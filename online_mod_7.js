...
(function () {
  ...
  function rezka2(component, _object) {
    var network = new Lampa.Reguest();
    var extract = {};
    var embed = component.proxy('rezka2') + 'https://hdrezkarfv.org/';
    var object = _object;
    var select_title = '';
    var prefer_mp4 = Lampa.Storage.field('online_mod_prefer_mp4') === true;
    var logged_in = Lampa.Storage.field('online_mod_rezka2_status') === true && !component.proxy('rezka2');
    var filter_items = {};
    var choice = {
      season: 0,
      voice: 0,
    ...
    function getPage(url) {
      network.clear();
      network.timeout(10000);
      network.silent(component.proxy('rezka2') + url, function (str) {
        extractData(str);
  ...
  function component(object) {
    ...
    this.proxy = function (name) {
      //let my_proxy = 'https://lampa-cors.herokuapp.com/'
      ...
      if (Lampa.Storage.field('online_mod_proxy_' + name) === true) {
        ...
        if (name === 'rezka') return 'https://cors.eu.org/';
        if (name === 'rezka2') return 'https://cors.eu.org/';
  ...
  function rezka2Login(success, error) {
    ...
    var postdata = 'login_name=' + encodeURIComponent(Lampa.Storage.field('online_mod_rezka2_name'));
    postdata += '&login_password=' + encodeURIComponent(Lampa.Storage.field('online_mod_rezka2_password'));
