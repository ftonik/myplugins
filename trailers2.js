(function () {
    ...
    function main(oncomplite, onerror) {
      ...
      get('/now_playing', 1, function (json) {
        append(Lampa.Lang.translate('trailers_tranding'), 'trending', '/now_playing', json);
      }, status.error.bind(status));
      get('/upcoming', 1, function (json) {
        append(Lampa.Lang.translate('trailers_anticipated'), 'anticipated', '/upcoming', json);
      }, status.error.bind(status));
      get('/popular', 1, function (json) {
        append(Lampa.Lang.translate('trailers_popular'), 'popular', '/popular', json);
      }, status.error.bind(status));
